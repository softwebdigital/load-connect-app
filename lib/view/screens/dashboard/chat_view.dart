...
import 'package:load_connect/view/providers/chat_message_provider.dart';
...
class ChatViewScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => ChatMessagesProvider(chat.sentTo!.id!),
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            title: Column(
              ...
              children: [
                Text(
                  "${chat.sentTo!.lastName} ${chat.sentTo!.firstName}",
